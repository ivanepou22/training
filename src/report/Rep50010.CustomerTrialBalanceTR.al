report 50010 "Customer - Trial Balance - TR"
{
    DefaultLayout = RDLC;
    RDLCLayout = './CustomerTrialBalanceTr.rdlc';
    AdditionalSearchTerms = 'payment due,order status';
    Caption = 'Customer - Trial Balance - TR';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            begin
                ...
                if Customer."Student No." <> '' then begin
                    Student.Get(Customer."Student No.");
    ...
    var
        ...
        CustTrialBalanceCaptionLbl: Label 'Customer - Trial Balance TR';
